...
class mapa
{
  ...
  public function view_render_modulos($courses_mod){
    ...
    $array_images_m1 = [
      ...
      ['imagen' => './universidad/static/images/money-bills.svg', 'cat_id' => '29', 'class-baner' => 'bg-[var(--color-primary)]', 'class-card' => 'bg-card-gradient-blue'],
      ['imagen' => './universidad/static/images/money-check-dollar.svg', 'cat_id' => '29', 'class-baner' => 'bg-[var(--color-primary)]', 'class-card' => 'bg-card-gradient-blue'],
      ['imagen' => './universidad/static/images/money-check-dollar-pen.svg', 'cat_id' => '29', 'class-baner' => 'bg-[var(--color-primary)]', 'class-card' => 'bg-card-gradient-blue'],
      ['imagen' => './universidad/static/images/file.svg', 'cat_id' => '29', 'class-baner' => 'bg-[var(--color-primary)]', 'class-card' => 'bg-card-gradient-blue'],
      ['imagen' => './universidad/static/images/list-ol.svg', 'cat_id' => '29', 'class-baner' => 'bg-[var(--color-primary)]', 'class-card' => 'bg-card-gradient-blue'],
      ['imagen' => './universidad/static/images/list-tree.svg', 'cat_id' => '29', 'class-baner' => 'bg-[var(--color-primary)]', 'class-card' => 'bg-card-gradient-blue'],
      ['imagen' => './universidad/static/images/cart-flatbed-boxes.svg', 'cat_id' => '29', 'class-baner' => 'bg-[var(--color-primary)]', 'class-card' => 'bg-card-gradient-blue'],
      ['imagen' => './universidad/static/images/file-contract.svg', 'cat_id' => '29', 'class-baner' => 'bg-[var(--color-primary)]', 'class-card' => 'bg-card-gradient-blue'],
      ...
      ['imagen' => './universidad/static/images/idea-purple.svg', 'cat_id' => '26', 'class-baner' => 'bg-[var(--color-blue-check)]', 'class-card' => 'bg-card-gradient-purple'],
      ['imagen' => './universidad/static/images/shield-purple.svg', 'cat_id' => '26', 'class-baner' => 'bg-[var(--color-blue-check)]', 'class-card' => 'bg-card-gradient-purple'],
      ['imagen' => './universidad/static/images/graphic-purple.svg', 'cat_id' => '26', 'class-baner' => 'bg-[var(--color-blue-check)]', 'class-card' => 'bg-card-gradient-purple'],
      ['imagen' => './universidad/static/images/idea-purple.svg', 'cat_id' => '27', 'class-baner' => 'bg-[var(--color-blue-check)]', 'class-card' => 'bg-card-gradient-purple'],
      ['imagen' => './universidad/static/images/shield-purple.svg', 'cat_id' => '27', 'class-baner' => 'bg-[var(--color-blue-check)]', 'class-card' => 'bg-card-gradient-purple'],
      ['imagen' => './universidad/static/images/graphic-purple.svg', 'cat_id' => '27', 'class-baner' => 'bg-[var(--color-blue-check)]', 'class-card' => 'bg-card-gradient-purple'],
